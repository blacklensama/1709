...
namespace Wxwinter.BPM.Machine.Design.FreeFormEditing
{
    ...
    internal class ConnectorEditor
    {
        ...
        void SetIsHitTestVisibleForOverlappingStartDots(bool hitTestVisible)
        {
            ...
            {
                overlappingConnector.startDotGrid.IsHitTestVisible = hitTestVisible;
            }
        }
        ...
        public void Update(Point newPoint)
        {
            ...
            Debug.Assert(this.activeEditPoint != null, "activeEditPoint is null");
        ...
        void DisplayEditPoints()
        {
            ...
            Debug.Assert(adornerLayer != null, "AdornerLayer is null.");
