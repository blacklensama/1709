...
namespace Wxwinter.BPM.WFDesigner {
    ...
    public partial class EndNode : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(EndNode).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(EndNode));
        ...
        private string FindResource() {
            string[] resources = typeof(EndNode).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".EndNode.g.xaml") || resource.Equals("EndNode.g.xaml"))) {
                    return resource;
                }
            }
