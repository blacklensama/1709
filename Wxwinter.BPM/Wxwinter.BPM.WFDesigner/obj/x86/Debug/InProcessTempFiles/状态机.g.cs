...
namespace Wxwinter.BPM.WFDesigner.template {
    ...
    public partial class 状态机流程 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private string FindResource() {
            string[] resources = typeof(状态机流程).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".状态机.g.xaml") || resource.Equals("状态机.g.xaml"))) {
                    return resource;
                }
            }
