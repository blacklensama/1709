...
namespace csExWB
{
    ...
    public class cHTMLElementEvents : HTMLElementEvents2
    {
        ...
        {
           // if (pEvtObj.SrcElement.tagName.Equals("table"))
              if (doubleClickFunc != null)
               {
                
                   doubleClickFunc(pEvtObj.SrcElement);
                    return true;
        ...
        public delegate bool isControlPart(IHTMLElement e);
        public delegate void resizeWork(IHTMLElement e) ;
        public delegate void doubleClickWork(IHTMLElement e);
        public delegate void mouseUP(IHTMLElement e);
        public delegate void targetOnOut(IHTMLElement e, int tag); 

        public canBeEdit canBeEditFunc = null;
        public isControlPart isControlPartFunc = null;
        public resizeWork resizeFunc = null;
        public doubleClickWork doubleClickFunc = null;
        public targetOnOut targetOnOutFunc = null;
        public mouseUP mouseUPFunc = null;

        bool HTMLElementEvents2.onkeypress(IHTMLEventObj pEvtObj)
        {
            if (canBeEditFunc != null)
                if (!canBeEditFunc())
                    return false;
        ...
        {
            if (targetOnOutFunc != null)
            {
                targetOnOutFunc(pEvtObj.SrcElement, 0);
            }
        ...
        void HTMLElementEvents2.onmouseover(IHTMLEventObj pEvtObj)
        {
            if (targetOnOutFunc != null)
            {
                targetOnOutFunc(pEvtObj.SrcElement, 1);
            }
        ...
        void HTMLElementEvents2.onmouseup(IHTMLEventObj pEvtObj)
        {
            ...
            {
                this.mouseUPFunc(pEvtObj.SrcElement);
            }
        ...
        {
            if(isControlPartFunc!=null)
                if(isControlPartFunc(pEvtObj.SrcElement))
                    return false ;
