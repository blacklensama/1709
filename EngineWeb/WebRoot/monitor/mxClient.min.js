...
mxLog.addButton("DOM",function(){var a=mxUtils.getInnerHtml(document.body);mxLog.debug(a)});mxLog.addButton("Trace",function(){mxLog.TRACE=!mxLog.TRACE;mxLog.TRACE?mxLog.debug("Tracing enabled"):mxLog.debug("Tracing disabled")});mxLog.addButton("Copy",function(){try{mxUtils.copy(mxLog.textarea.value)}catch(a){mxUtils.alert(a)}});mxLog.addButton("Show",function(){try{mxUtils.popup(mxLog.textarea.value)}catch(a){mxUtils.alert(a)}});mxLog.addButton("Clear",function(){mxLog.textarea.value=""});c=document.body.clientHeight||
document.documentElement.clientHeight;mxLog.window=new mxWindow(a,b,Math.max(0,document.body.clientWidth-320),Math.max(0,c-210),300,160);mxLog.window.setMaximizable(true);mxLog.window.setScrollable(false);mxLog.window.setResizable(true);mxLog.window.setClosable(true);mxLog.window.destroyOnClose=false;if((mxClient.IS_NS||mxClient.IS_IE)&&!mxClient.IS_GC&&!mxClient.IS_SF&&document.compatMode!="BackCompat"){var f=mxLog.window.getElement(),a=function(){mxLog.textarea.style.height=Math.max(0,f.offsetHeight-
70)+"px"};mxLog.window.addListener(mxEvent.RESIZE_END,a);mxLog.window.addListener(mxEvent.MAXIMIZE,a);mxLog.window.addListener(mxEvent.NORMALIZE,a);mxLog.textarea.style.height="92px"}}},info:function(){mxLog.writeln(mxUtils.toString(navigator))},addButton:function(a,b){var c=document.createElement("button");mxUtils.write(c,a);mxEvent.addListener(c,"click",b);mxLog.td.appendChild(c)},isVisible:function(){return mxLog.window!=null?mxLog.window.isVisible():false},show:function(){mxLog.setVisible(true)},
setVisible:function(a){mxLog.window==null&&mxLog.init();mxLog.window!=null&&mxLog.window.setVisible(a)},enter:function(a){if(mxLog.TRACE){mxLog.writeln("Entering "+a);return(new Date).getTime()}},leave:function(a,b){if(mxLog.TRACE){var c=b!=0?" ("+((new Date).getTime()-b)+" ms)":"";mxLog.writeln("Leaving "+a+c)}},debug:function(){mxLog.DEBUG&&mxLog.writeln.apply(this,arguments)},warn:function(){mxLog.WARN&&mxLog.writeln.apply(this,arguments)},write:function(){for(var a="",b=0;b<arguments.length;b++){a=
a+arguments[b];b<arguments.length-1&&(a=a+" ")}if(mxLog.textarea!=null){mxLog.textarea.value=mxLog.textarea.value+a;if(navigator.userAgent.indexOf("Presto/2.5")>=0){mxLog.textarea.style.visibility="hidden";mxLog.textarea.style.visibility="visible"}mxLog.textarea.scrollTop=mxLog.textarea.scrollHeight}else mxLog.buffer=mxLog.buffer+a},writeln:function(){for(var a="",b=0;b<arguments.length;b++){a=a+arguments[b];b<arguments.length-1&&(a=a+" ")}mxLog.write(a+"\n")}},mxObjectIdentity={FIELD_NAME:"mxObjectId",
counter:0,get:function(a){if(typeof a=="object"&&a[mxObjectIdentity.FIELD_NAME]==null){var b=mxUtils.getFunctionName(a.constructor);a[mxObjectIdentity.FIELD_NAME]=b+"#"+mxObjectIdentity.counter++}return a[mxObjectIdentity.FIELD_NAME]},clear:function(a){typeof a=="object"&&delete a[mxObjectIdentity.FIELD_NAME]}};function mxDictionary(){this.clear()}mxDictionary.prototype.map=null;mxDictionary.prototype.clear=function(){this.map={}};mxDictionary.prototype.get=function(a){return this.map[mxObjectIdentity.get(a)]};
...
null)return d;a=a.nextSibling}return null},findNodeByAttribute:function(){return document.documentMode>=9?function(a,b,c){var d=null;if(a.nodeType==mxConstants.NODETYPE_ELEMENT&&a.getAttribute(b)==c)d=a;else for(a=a.firstChild;a!=null&&d==null;){d=mxUtils.findNodeByAttribute(a,b,c);a=a.nextSibling}return d}:mxClient.IS_IE?function(a,b,c){return a.ownerDocument.selectSingleNode("//*[@"+b+"='"+c+"']")}:function(a,b,c){return a.ownerDocument.evaluate("//*[@"+b+"='"+c+"']",a.ownerDocument,null,XPathResult.ANY_TYPE,
null).iterateNext()}}(),getFunctionName:function(a){var b=null;if(a!=null)if(a.name!=null)b=a.name;else{a=a.toString();for(b=9;a.charAt(b)==" ";)b++;var c=a.indexOf("(",b),b=a.substring(b,c)}return b},indexOf:function(a,b){if(a!=null&&b!=null)for(var c=0;c<a.length;c++)if(a[c]==b)return c;return-1},remove:function(a,b){var c=null;if(typeof b=="object")for(var d=mxUtils.indexOf(b,a);d>=0;){b.splice(d,1);c=a;d=mxUtils.indexOf(b,a)}for(var e in b)if(b[e]==a){delete b[e];c=a}return c},isNode:function(a,
b,c,d){return a!=null&&!isNaN(a.nodeType)&&(b==null||a.nodeName.toLowerCase()==b.toLowerCase())?c==null||a.getAttribute(c)==d:false},getChildNodes:function(a,b){for(var b=b||mxConstants.NODETYPE_ELEMENT,c=[],d=a.firstChild;d!=null;){d.nodeType==b&&c.push(d);d=d.nextSibling}return c},createXmlDocument:function(){var a=null;document.implementation&&document.implementation.createDocument?a=document.implementation.createDocument("","",null):window.ActiveXObject&&(a=new ActiveXObject("Microsoft.XMLDOM"));
return a},parseXml:function(){return mxClient.IS_IE&&(typeof document.documentMode==="undefined"||document.documentMode<9)?function(a){var b=mxUtils.createXmlDocument();b.async="false";b.loadXML(a);return b}:function(a){return(new DOMParser).parseFromString(a,"text/xml")}}(),clearSelection:function(){if(document.selection)return function(){document.selection.empty()};if(window.getSelection)return function(){window.getSelection().removeAllRanges()}}(),getPrettyXml:function(a,b,c){var d=[];if(a!=null){b=
b||"  ";c=c||"";if(a.nodeType==mxConstants.NODETYPE_TEXT)d.push(a.nodeValue);else{d.push(c+"<"+a.nodeName);var e=a.attributes;if(e!=null)for(var f=0;f<e.length;f++){var g=mxUtils.htmlEntities(e[f].nodeValue);d.push(" "+e[f].nodeName+'="'+g+'"')}e=a.firstChild;if(e!=null){for(d.push(">\n");e!=null;){d.push(mxUtils.getPrettyXml(e,b,c+b));e=e.nextSibling}d.push(c+"</"+a.nodeName+">\n")}else d.push("/>\n")}}return d.join("")},removeWhitespace:function(a,b){for(var c=b?a.previousSibling:a.nextSibling;c!=
null&&c.nodeType==mxConstants.NODETYPE_TEXT;){var d=b?c.previousSibling:c.nextSibling,e=mxUtils.getTextContent(c);mxUtils.trim(e).length==0&&c.parentNode.removeChild(c);c=d}},htmlEntities:function(a,b){a=(a||"").replace(/&/g,"&amp;");a=a.replace(/"/g,"&quot;");a=a.replace(/\'/g,"&#39;");a=a.replace(/</g,"&lt;");a=a.replace(/>/g,"&gt;");if(b==null||b)a=a.replace(/\n/g,"&#xa;");return a},isVml:function(a){return a!=null&&a.tagUrn=="urn:schemas-microsoft-com:vml"},getXml:function(a,b){var c="";if(a!=
null){c=a.xml;c=c==null?a.innerHTML?a.innerHTML:(new XMLSerializer).serializeToString(a):c.replace(/\r\n\t[\t]*/g,"").replace(/>\r\n/g,">").replace(/\r\n/g,"\n")}return c=c.replace(/\n/g,b||"&#xa;")},getTextContent:function(a){var b="";if(a!=null){if(a.firstChild!=null)a=a.firstChild;b=a.nodeValue||""}return b},getInnerHtml:function(){return mxClient.IS_IE?function(a){return a!=null?a.innerHTML:""}:function(a){return a!=null?(new XMLSerializer).serializeToString(a):""}}(),getOuterHtml:function(){return mxClient.IS_IE?
...
a.width,i=a.height,l=mxUtils.getValue(a.style,mxConstants.STYLE_STARTSIZE);if(l>0)if(mxUtils.getValue(a.style,mxConstants.STYLE_HORIZONTAL,true)){h=a.y+l/2;i=l}else{g=a.x+l/2;k=l}k=Math.max(e,k*d);i=Math.max(e,i*d);if(f>0){k=Math.min(k,f);i=Math.min(i,f)}a=new mxRectangle(g-k/2,h-i/2,k,i);return mxUtils.contains(a,b,c)}return true},getOffset:function(a,b){var c=0,d=0;if(b!=null&&b)var e=document.body,f=document.documentElement,c=c+(e.scrollLeft||f.scrollLeft),d=d+(e.scrollTop||f.scrollTop);for(;a.offsetParent;){c=
c+a.offsetLeft;d=d+a.offsetTop;a=a.offsetParent}return new mxPoint(c,d)},getScrollOrigin:function(a){for(var b=document.body,c=document.documentElement,d=new mxPoint(b.scrollLeft||c.scrollLeft,b.scrollTop||c.scrollTop);a!=null&&a!=b&&a!=c;){if(!isNaN(a.scrollLeft)&&!isNaN(a.scrollTop)){d.x=d.x+a.scrollLeft;d.y=d.y+a.scrollTop}a=a.parentNode}return d},convertPoint:function(a,b,c){var d=mxUtils.getScrollOrigin(a),a=mxUtils.getOffset(a);a.x=a.x-d.x;a.y=a.y-d.y;return new mxPoint(b-a.x,c-a.y)},ltrim:function(a,
b){return a.replace(RegExp("^["+(b||"\\s")+"]+","g"),"")},rtrim:function(a,b){return a.replace(RegExp("["+(b||"\\s")+"]+$","g"),"")},trim:function(a,b){return mxUtils.ltrim(mxUtils.rtrim(a,b),b)},isNumeric:function(a){return a!=null&&(a.length==null||a.length>0&&a.indexOf("0x")<0&&a.indexOf("0X")<0)&&!isNaN(a)},mod:function(a,b){return(a%b+b)%b},intersection:function(a,b,c,d,e,f,g,h){var k=(h-f)*(c-a)-(g-e)*(d-b),g=((g-e)*(b-f)-(h-f)*(a-e))/k,e=((c-a)*(b-f)-(d-b)*(a-e))/k;return g>=0&&g<=1&&e>=0&&
e<=1?new mxPoint(a+g*(c-a),b+g*(d-b)):null},ptSegDistSq:function(a,b,c,d,e,f){c=c-a;d=d-b;e=e-a;f=f-b;if(e*c+f*d<=0)c=0;else{e=c-e;f=d-f;a=e*c+f*d;c=a<=0?0:a*a/(c*c+d*d)}e=e*e+f*f-c;e<0&&(e=0);return e},relativeCcw:function(a,b,c,d,e,f){c=c-a;d=d-b;e=e-a;f=f-b;a=e*d-f*c;if(a==0){a=e*c+f*d;if(a>0){a=(e-c)*c+(f-d)*d;a<0&&(a=0)}}return a<0?-1:a>0?1:0},animateChanges:function(a,b){mxEffects.animateChanges.apply(this,arguments)},cascadeOpacity:function(a,b,c){mxEffects.cascadeOpacity.apply(this,arguments)},
...
mxDragSource.prototype.currentGraph=null;mxDragSource.prototype.currentDropTarget=null;mxDragSource.prototype.currentPoint=null;mxDragSource.prototype.currentGuide=null;mxDragSource.prototype.currentHighlight=null;mxDragSource.prototype.autoscroll=!0;mxDragSource.prototype.guidesEnabled=!0;mxDragSource.prototype.gridEnabled=!0;mxDragSource.prototype.highlightDropTargets=!0;mxDragSource.prototype.isEnabled=function(){return this.enabled};mxDragSource.prototype.setEnabled=function(a){this.enabled=a};
mxDragSource.prototype.isGuidesEnabled=function(){return this.guidesEnabled};mxDragSource.prototype.setGuidesEnabled=function(a){this.guidesEnabled=a};mxDragSource.prototype.isGridEnabled=function(){return this.gridEnabled};mxDragSource.prototype.setGridEnabled=function(a){this.gridEnabled=a};mxDragSource.prototype.getGraphForEvent=function(){return null};mxDragSource.prototype.getDropTarget=function(a,b,c){return a.getCellAt(b,c)};mxDragSource.prototype.createDragElement=function(){return this.element.cloneNode(true)};
mxDragSource.prototype.createPreviewElement=function(){return null};
...
mxDragSource.prototype.startDrag=function(a){this.dragElement=this.createDragElement(a);this.dragElement.style.position="absolute";this.dragElement.style.zIndex="3";mxUtils.setOpacity(this.dragElement,70)};mxDragSource.prototype.stopDrag=function(){if(this.dragElement!=null){this.dragElement.parentNode!=null&&this.dragElement.parentNode.removeChild(this.dragElement);this.dragElement=null}};
...
";color:"+i.fontColor+";";(i.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&(c=c+"font-weight:bold;");(i.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC&&(c=c+"font-style:italic;");(i.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&(c=c+"font-decoration:underline;");b==mxConstants.ALIGN_CENTER?c=c+"text-align:center;":b==mxConstants.ALIGN_RIGHT&&(c=c+"text-align:right;");a=a.replace(/&nbsp;/g,"&#160;");return mxUtils.parseXml('<div xmlns="http://www.w3.org/1999/xhtml" style="'+
...
"none");if(g&&e.stroke!=null){c.setAttribute("stroke",e.stroke.toLowerCase());if(e.strokeWidth!=1){if(c.nodeName=="rect"&&d)e.strokeWidth=Math.max(1,e.strokeWidth);c.setAttribute("stroke-width",e.strokeWidth)}if(c.nodeName=="path"){e.linejoin!=null&&e.linejoin!="miter"&&c.setAttribute("stroke-linejoin",e.linejoin);if(e.linecap!=null){f=e.linecap;f=="flat"&&(f="butt");f!="butt"&&c.setAttribute("stroke-linecap",f)}e.miterlimit!=null&&(!b||e.miterlimit!=10)&&c.setAttribute("stroke-miterlimit",e.miterlimit)}if(e.dashed){f=
...
p.setAttribute("font-style","italic");(i.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&p.setAttribute("text-decoration","underline");m!="start"&&p.setAttribute("text-anchor",m);(!b||q!=mxConstants.DEFAULT_FONTSIZE)&&p.setAttribute("font-size",Math.floor(q*i.scale)+"px");(!b||i.fontFamily!=mxConstants.DEFAULT_FONTFAMILY)&&p.setAttribute("font-family",i.fontFamily);p.setAttribute("fill",i.fontColor);h=l.split("\n");l=q*1.25;m=k-(k>0?q+(h.length-1)*l:h.length*l-1);n==null||n==mxConstants.ALIGN_TOP?
d=Math.max(d-3*i.scale,d+m/2+(k>0?l/2-8:0)):n==mxConstants.ALIGN_MIDDLE?d=d+m/2:n==mxConstants.ALIGN_BOTTOM&&(d=Math.min(d,d+m+2*i.scale));d=d+q;for(k=0;k<h.length;k++){n=g("text");n.setAttribute("x",r(c*i.scale));n.setAttribute("y",r(d*i.scale));mxUtils.write(n,h[k]);p.appendChild(n);d=d+q*1.3}}a.appendChild(p)}},begin:function(){n=g("path");o=[];p=null;l=true},moveTo:function(a,b){if(o!=null){a=a+i.dx;b=b+i.dy;o.push("M "+r(a*i.scale)+" "+r(b*i.scale));d&&(p=new mxPoint(a,b))}},lineTo:function(a,
b){if(o!=null){a=a+i.dx;b=b+i.dy;o.push("L "+r(a*i.scale)+" "+r(b*i.scale));if(d){p!=null&&(l&&a!=p.x&&b!=p.y)&&(l=false);p=new mxPoint(a,b)}}},quadTo:function(a,b,c,d){if(o!=null){a=a+i.dx;b=b+i.dy;c=c+i.dx;d=d+i.dy;o.push("Q "+r(a*i.scale)+" "+r(b*i.scale)+" "+r(c*i.scale)+" "+r(d*i.scale));l=false}},curveTo:function(a,b,c,d,e,f){if(o!=null){a=a+i.dx;b=b+i.dy;c=c+i.dx;d=d+i.dy;e=e+i.dx;f=f+i.dy;o.push("C "+r(a*i.scale)+" "+r(b*i.scale)+" "+r(c*i.scale)+" "+r(d*i.scale)+" "+r(e*i.scale)+" "+r(f*
i.scale));l=false}},close:function(){o!=null&&o.push("Z")},stroke:function(){w(n,i,false,true)},fill:function(){w(n,i,true,false)},fillAndStroke:function(){w(n,i,true,true)},shadow:function(a,b){this.save();this.setStrokeColor(a);if(b){this.setFillColor(a);this.fillAndStroke()}else this.stroke();this.restore()},clip:function(){if(n!=null){if(o!=null){n.setAttribute("d",o.join(" "));o=null}var a=++t,b=g("clipPath");b.setAttribute("id",a);b.appendChild(n);h.appendChild(b);i.clip=a}}}};
function mxGuide(a,b){this.graph=a;this.setStates(b)}mxGuide.prototype.graph=null;mxGuide.prototype.states=null;mxGuide.prototype.horizontal=!0;mxGuide.prototype.vertical=!0;mxGuide.prototype.guideX=null;mxGuide.prototype.guideY=null;mxGuide.prototype.crisp=!0;mxGuide.prototype.setStates=function(a){this.states=a};mxGuide.prototype.isEnabledForEvent=function(){return true};mxGuide.prototype.getGuideTolerance=function(){return this.graph.gridSize*this.graph.view.scale/2};
mxGuide.prototype.createGuideShape=function(){var a=new mxPolyline([],mxConstants.GUIDE_COLOR,mxConstants.GUIDE_STROKEWIDTH);a.crisp=this.crisp;a.isDashed=true;return a};
...
mxStackLayout.prototype.execute=function(a){if(a!=null){var b=this.isHorizontal(),c=this.graph.getModel(),d=this.getParentSize(a),e=0;d!=null&&(e=b?d.height:d.width);var e=e-(2*this.spacing+2*this.border),f=this.graph.isSwimlane(a)?this.graph.getStartSize(a):new mxRectangle,e=e-(b?f.height:f.width),g=this.x0+f.width+this.border,f=this.y0+f.height+this.border;c.beginUpdate();try{for(var h=0,k=null,i=c.getChildCount(a),l=0;l<i;l++){var m=c.getChildAt(a,l);if(!this.isVertexIgnored(m)&&this.isVertexMovable(m)){var n=
c.getGeometry(m);if(n!=null){n=n.clone();if(this.wrap!=null&&k!=null&&(b&&k.x+k.width+n.width+2*this.spacing>this.wrap||!b&&k.y+k.height+n.height+2*this.spacing>this.wrap)){k=null;b?f=f+(h+this.spacing):g=g+(h+this.spacing);h=0}h=Math.max(h,b?n.height:n.width);if(k!=null)b?n.x=k.x+k.width+this.spacing:n.y=k.y+k.height+this.spacing;else if(!this.keepFirstLocation)b?n.x=g:n.y=f;b?n.y=f:n.x=g;if(this.fill&&e>0)b?n.height=e:n.width=e;c.setGeometry(m,n);k=n}}}if(this.resizeParent&&d!=null&&k!=null&&!this.graph.isCellCollapsed(a)){d=
d.clone();b?d.width=k.x+k.width+this.spacing:d.height=k.y+k.height+this.spacing;c.setGeometry(a,d)}else if(this.resizeLast&&d!=null&&k!=null)b?k.width=d.width-k.x-this.spacing:k.height=d.height-k.y-this.spacing}finally{c.endUpdate()}}};function mxPartitionLayout(a,b,c,d){mxGraphLayout.call(this,a);this.horizontal=b!=null?b:true;this.spacing=c||0;this.border=d||0}mxPartitionLayout.prototype=new mxGraphLayout;mxPartitionLayout.prototype.constructor=mxPartitionLayout;
...
function mxGraphHierarchyModel(a,b,c,d,e,f,g){var h=a.getGraph();this.deterministic=e;this.tightenToSource=f;this.scanRanksFromSinks=g;this.roots=c;this.parent=d;this.vertexMapper={};this.edgeMapper={};this.maxRank=0;c=[];b==null&&(b=this.graph.getChildVertices(d));this.maxRank=this.scanRanksFromSinks?0:this.SOURCESCANSTARTRANK;this.createInternalCells(a,b,c);for(a=0;a<b.length;a++){d=c[a].connectsAsSource;for(e=0;e<d.length;e++){f=d[e];g=f.edges;if(g!=null&&g.length>0){var g=g[0],k=h.getView().getVisibleTerminal(g,
false),k=mxCellPath.create(k),k=this.vertexMapper[k];if(c[a]==k){k=h.getView().getVisibleTerminal(g,true);k=mxCellPath.create(k);k=this.vertexMapper[k]}if(k!=null&&c[a]!=k){f.target=k;if(k.connectsAsTarget.length==0)k.connectsAsTarget=[];mxUtils.indexOf(k.connectsAsTarget,f)<0&&k.connectsAsTarget.push(f)}}}c[a].temp[0]=1}}mxGraphHierarchyModel.prototype.scanRanksFromSinks=!0;mxGraphHierarchyModel.prototype.maxRank=null;mxGraphHierarchyModel.prototype.vertexMapper=null;
mxGraphHierarchyModel.prototype.edgeMapper=null;mxGraphHierarchyModel.prototype.ranks=null;mxGraphHierarchyModel.prototype.roots=null;mxGraphHierarchyModel.prototype.parent=null;mxGraphHierarchyModel.prototype.dfsCount=0;mxGraphHierarchyModel.prototype.SOURCESCANSTARTRANK=1E8;mxGraphHierarchyModel.prototype.tightenToSource=!1;
...
mxGraphHierarchyModel.prototype.initialRank=function(){var a=[];if(!this.scanRanksFromSinks&&this.roots!=null)for(var b=0;b<this.roots.length;b++){var c=this.vertexMapper[mxCellPath.create(this.roots[b])];c!=null&&a.push(c)}if(this.scanRanksFromSinks)for(var d in this.vertexMapper){c=this.vertexMapper[d];(c.connectsAsSource==null||c.connectsAsSource.length==0)&&a.push(c)}if(a.length==0)for(d in this.vertexMapper){c=this.vertexMapper[d];if(c.connectsAsTarget==null||c.connectsAsTarget.length==0){a.push(c);
this.scanRanksFromSinks=false;this.maxRank=this.SOURCESCANSTARTRANK}}for(d in this.vertexMapper){c=this.vertexMapper[d];c.temp[0]=-1}for(var e=a.slice();a.length>0;){var c=a[0],f,g;if(this.scanRanksFromSinks){f=c.connectsAsSource;g=c.connectsAsTarget}else{f=c.connectsAsTarget;g=c.connectsAsSource}var h=true,k=0;if(!this.scanRanksFromSinks)k=this.SOURCESCANSTARTRANK;for(b=0;b<f.length;b++){var i=f[b];if(i.temp[0]==5270620){i=this.scanRanksFromSinks?i.target:i.source;k=this.scanRanksFromSinks?Math.max(k,
i.temp[0]+1):Math.min(k,i.temp[0]-1)}else{h=false;break}}if(h){c.temp[0]=k;this.maxRank=this.scanRanksFromSinks?Math.max(this.maxRank,k):Math.min(this.maxRank,k);if(g!=null)for(b=0;b<g.length;b++){i=g[b];i.temp[0]=5270620;i=this.scanRanksFromSinks?i.source:i.target;if(i.temp[0]==-1){a.push(i);i.temp[0]=-2}}a.shift()}else{b=a.shift();a.push(c);if(b==c&&a.length==1)break}}if(this.scanRanksFromSinks){if(this.tightenToSource)for(b=0;b<e.length;b++){c=e[b];a=1E6;for(d=0;d<c.connectsAsTarget.length;d++){i=
c.connectsAsTarget[d];i=i.source;c.temp[0]=Math.min(a,i.temp[0]-1);a=c.temp[0]}}}else{for(d in this.vertexMapper){c=this.vertexMapper[d];c.temp[0]=c.temp[0]-this.maxRank}this.maxRank=this.SOURCESCANSTARTRANK-this.maxRank}};
...
mxHierarchicalLayout.prototype.interRankCellSpacing=50;mxHierarchicalLayout.prototype.interHierarchySpacing=60;mxHierarchicalLayout.prototype.parallelEdgeSpacing=10;mxHierarchicalLayout.prototype.orientation=mxConstants.DIRECTION_NORTH;mxHierarchicalLayout.prototype.fineTuning=!0;mxHierarchicalLayout.prototype.fixRoots=!1;mxHierarchicalLayout.prototype.layoutFromSinks=!0;mxHierarchicalLayout.prototype.tightenToSource=!0;mxHierarchicalLayout.prototype.disableEdgeStyle=!0;
mxHierarchicalLayout.prototype.promoteEdges=!0;mxHierarchicalLayout.prototype.traverseAncestors=!0;mxHierarchicalLayout.prototype.model=null;mxHierarchicalLayout.prototype.getModel=function(){return this.model};
mxHierarchicalLayout.prototype.execute=function(a,b){this.parent=a;var c=this.graph.model;if(!(b==null&&a==null)){if(b!=null&&a!=null){for(var d=[],e=0;e<b.length;e++)c.isAncestor(a,b[e])&&d.push(b[e]);this.roots=d}else this.roots=b==null?this.findTreeRoots(a):b;if(this.roots!=null){c=this.graph.getModel();c.beginUpdate();try{this.run(a);this.resizeParent&&!this.graph.isCellCollapsed(a)&&this.graph.updateGroupBounds([a],this.parentBorder,this.moveParent)}finally{c.endUpdate()}}}};
mxHierarchicalLayout.prototype.findTreeRoots=function(a){var b=[];if(a!=null){for(var c=this.graph.model,d=c.getChildCount(a),e=null,f=0,g=0;g<d;g++){var h=c.getChildAt(a,g),k=[];this.traverseAncestors?k=c.getDescendants(h):k.push(h);for(var i=0;i<k.length;i++){h=k[i];if(c.isVertex(h)&&this.graph.isCellVisible(h)){for(var l=this.getEdges(h),m=0,n=0,o=0;o<l.length;o++)this.graph.view.getVisibleTerminal(l[o],true)==h?m++:n++;n==0&&m>0&&b.push(h);l=n-m;if(l>f){f=l;e=h}}}}b.length==0&&e!=null&&b.push(e)}return b};
...
mxHierarchicalLayout.prototype.run=function(a){var b=[],c=null,d=null,e=null;if(this.fixRoots){c=[];d=[];e=[]}for(var f=0;f<this.roots.length;f++){for(var g=true,h=0;g&&h<b.length;h++){var k=mxCellPath.create(this.roots[f]);b[h][k]!=null&&(g=false)}if(g){h=[];h.push(this.roots[f]);k=null;if(this.fixRoots){c.push(this.roots[f]);g=this.getVertexBounds(this.roots[f]).getPoint();d.push(g);k=[]}for(g={};h.length>0;){var i=h.shift(),l=mxCellPath.create(i);if(g[l]==null){g[l]=i;if(this.fixRoots)for(var m=
this.graph.getIncomingEdges(i,a),l=0;l<m.length;l++)k.push(m[l]);i=this.graph.getOpposites(this.getEdges(i),i);for(l=0;l<i.length;l++){m=mxCellPath.create(i[l]);g[m]==null&&h.push(i[l])}}}b.push(g);this.fixRoots&&e.push(k)}}for(f=h=0;f<b.length;f++){var g=b[f],m=[],n;for(n in g)m.push(g[n]);this.model=new mxGraphHierarchyModel(this,m,this.roots,a,this.deterministic,this.tightenToSource,this.layoutFromSinks);this.cycleStage(a);this.layeringStage();this.crossingStage(a);h=this.placementStage(h,a);if(this.fixRoots){l=
d[f];i=this.getVertexBounds(c[f]).getPoint();k=l.x-i.x;l=l.y-i.y;this.graph.moveCells(g,k,l);this.graph.moveCells(e[f+1],k,l)}}};mxHierarchicalLayout.prototype.cycleStage=function(a){(new mxMinimumCycleRemover(this)).execute(a)};mxHierarchicalLayout.prototype.layeringStage=function(){this.model.initialRank();this.model.fixRanks()};mxHierarchicalLayout.prototype.crossingStage=function(a){(new mxMedianHybridCrossingReduction(this)).execute(a)};
...
f=mxUtils.getValue(c.style,mxConstants.STYLE_FONTCOLOR,"black"),g=this.graph.model.isEdge(c.cell)?mxConstants.ALIGN_LEFT:mxUtils.getValue(c.style,mxConstants.STYLE_ALIGN,mxConstants.ALIGN_LEFT),h=(mxUtils.getValue(c.style,mxConstants.STYLE_FONTSTYLE,0)&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD;this.textarea.style.fontSize=d+"px";this.textarea.style.fontFamily=e;this.textarea.style.textAlign=g;this.textarea.style.color=f;this.textarea.style.fontWeight=h?"bold":"normal";d=this.getEditorBounds(c);
this.textarea.style.left=d.x+"px";this.textarea.style.top=d.y+"px";this.textarea.style.width=d.width+"px";this.textarea.style.height=d.height+"px";this.textarea.style.zIndex=5;c=this.getInitialValue(c,b);if(c==null||c.length==0){c=this.getEmptyLabelText();this.clearOnChange=true}else this.clearOnChange=false;this.setModified(false);this.textarea.value=c;this.graph.container.appendChild(this.textarea);if(this.textarea.style.display!="none"){this.textarea.focus();this.textarea.select()}}};
...
mxCellRenderer.prototype.createCellOverlays=function(a){var b=a.view.graph.getCellOverlays(a.cell),c=null;if(b!=null)for(var c=new mxDictionary,d=0;d<b.length;d++){var e=a.overlays!=null?a.overlays.remove(b[d]):null;if(e==null){e=new mxImageShape(new mxRectangle,b[d].image.src);e.dialect=a.view.graph.dialect;e.overlay=b[d];this.initializeOverlay(a,e);this.installCellOverlayListeners(a,b[d],e);if(b[d].cursor!=null)e.node.style.cursor=b[d].cursor}c.put(b[d],e)}a.overlays!=null&&a.overlays.visit(function(a,
b){b.destroy()});a.overlays=c};mxCellRenderer.prototype.initializeOverlay=function(a,b){b.init(a.view.getOverlayPane())};
...
mxGraph.prototype.swimlaneNesting=!0;mxGraph.prototype.swimlaneIndicatorColorAttribute=mxConstants.STYLE_FILLCOLOR;mxGraph.prototype.imageBundles=null;mxGraph.prototype.minFitScale=0.1;mxGraph.prototype.maxFitScale=8;mxGraph.prototype.panDx=0;mxGraph.prototype.panDy=0;mxGraph.prototype.collapsedImage=new mxImage(mxClient.imageBasePath+"/collapsed.gif",9,9);mxGraph.prototype.expandedImage=new mxImage(mxClient.imageBasePath+"/complete.gif",16,16);
...
if((this.minFitScale==null||c>this.minFitScale)&&(this.maxFitScale==null||c<this.maxFitScale))if(b)this.view.setScale(c);else if(mxUtils.hasScrollbars(this.container)){this.view.setScale(c);if(e.x!=null)this.container.scrollLeft=Math.round(e.x/f)*c-a-Math.max(0,(this.container.clientWidth-g*c)/2);if(e.y!=null)this.container.scrollTop=Math.round(e.y/f)*c-a-Math.max(0,(this.container.clientHeight-h*c)/2)}else this.view.scaleAndTranslate(c,e.x!=null?Math.floor(this.view.translate.x-e.x/f+a+1):a,e.y!=
null?Math.floor(this.view.translate.y-e.y/f+a+1):a)}return this.view.scale};mxGraph.prototype.scrollCellToVisible=function(a,b){var c=-this.view.translate.x,d=-this.view.translate.y,e=this.view.getState(a);if(e!=null){c=new mxRectangle(c+e.x,d+e.y,e.width,e.height);if(b&&this.container!=null){d=this.container.clientWidth;e=this.container.clientHeight;c.x=c.getCenterX()-d/2;c.width=d;c.y=c.getCenterY()-e/2;c.height=e}this.scrollRectToVisible(c)&&this.view.setTranslate(this.view.translate.x,this.view.translate.y)}};
...
this.currentState);e=this.edgeState.absolutePoints[this.edgeState.absolutePoints.length-1];f=this.edgeState.absolutePoints[0]}else{if(this.currentState!=null&&this.constraintHandler.currentConstraint==null){d=this.getTargetPerimeterPoint(this.currentState,b);d!=null&&(e=d)}if(this.sourceConstraint==null&&this.previous!=null){d=this.getSourcePerimeterPoint(this.previous,this.waypoints!=null&&this.waypoints.length>0?this.waypoints[0]:e,b);d!=null&&(f=d)}}if(this.currentState==null&&this.movePreviewAway){d=
e.x-f.x;g=e.y-f.y;h=Math.sqrt(d*d+g*g);e.x=e.x-d*4/h;e.y=e.y-g*4/h}if(this.shape==null){d=Math.abs(c.x-this.first.x);g=Math.abs(c.y-this.first.y);if(d>this.graph.tolerance||g>this.graph.tolerance){this.shape=this.createShape();this.updateCurrentState(b)}}if(this.shape!=null){if(this.edgeState!=null)this.shape.points=this.edgeState.absolutePoints;else{c=[f];this.waypoints!=null&&(c=c.concat(this.waypoints));c.push(e);this.shape.points=c}this.drawPreview()}mxEvent.consume(b.getEvent());b.consume()}else if(!this.isEnabled()||
!this.graph.isEnabled())this.constraintHandler.reset();else if(this.previous!=this.currentState&&this.edgeState==null){this.destroyIcons(this.icons);this.icons=null;if(this.currentState!=null&&this.error==null){this.icons=this.createIcons(this.currentState);if(this.icons==null){this.currentState.setCursor(mxConstants.CURSOR_CONNECT);b.consume()}}this.previous=this.currentState}else this.previous==this.currentState&&(this.currentState!=null&&this.icons==null&&!this.graph.isMouseDown)&&b.consume();
...
mxConstraintHandler.prototype.getImageForConstraint=function(){return this.pointImage};
mxConstraintHandler.prototype.update=function(a,b){if(this.isEnabled()){var c=this.getTolerance(),d=new mxRectangle(a.getGraphX()-c,a.getGraphY()-c,2*c,2*c),e=a.getCell()!=null?this.graph.isCellConnectable(a.getCell()):false;if(this.currentFocusArea==null||!mxUtils.intersects(this.currentFocusArea,d)||a.getState()!=null&&this.currentFocus!=null&&e&&this.graph.getModel().getParent(a.getCell())==this.currentFocus.cell){this.currentFocusArea=null;if(a.getState()!=this.currentFocus){this.currentFocus=
null;this.constraints=a.getState()!=null&&e?this.graph.getAllConnectionConstraints(a.getState(),b):null;if(this.constraints!=null){this.currentFocus=a.getState();this.currentFocusArea=new mxRectangle(a.getState().x,a.getState().y,a.getState().width,a.getState().height);if(this.focusIcons!=null){for(e=0;e<this.focusIcons.length;e++)this.focusIcons[e].destroy();this.focusPoints=this.focusIcons=null}this.focusIcons=[];this.focusPoints=[];for(e=0;e<this.constraints.length;e++){var f=this.graph.getConnectionPoint(a.getState(),
this.constraints[e]),g=this.getImageForConstraint(a.getState(),this.constraints[e],f),h=g.src,g=new mxRectangle(f.x-g.width/2,f.y-g.height/2,g.width,g.height),g=new mxImageShape(g,h);g.dialect=this.graph.dialect==mxConstants.DIALECT_SVG?mxConstants.DIALECT_SVG:mxConstants.DIALECT_VML;g.init(this.graph.getView().getOverlayPane());g.node.previousSibling!=null&&g.node.parentNode.insertBefore(g.node,g.node.parentNode.firstChild);h=mxUtils.bind(this,function(){return this.currentFocus!=null?this.currentFocus:
a.getState()});g.redraw();mxEvent.redirectMouseEvents(g.node,this.graph,h);this.currentFocusArea.add(g.bounds);this.focusIcons.push(g);this.focusPoints.push(f)}this.currentFocusArea.grow(c)}else if(this.focusIcons!=null){if(this.focusHighlight!=null){this.focusHighlight.destroy();this.focusHighlight=null}for(e=0;e<this.focusIcons.length;e++)this.focusIcons[e].destroy();this.focusPoints=this.focusIcons=null}}}this.currentPoint=this.currentConstraint=null;if(this.focusIcons!=null&&this.constraints!=
null&&(a.getState()==null||this.currentFocus==a.getState()))for(e=0;e<this.focusIcons.length;e++)if(mxUtils.intersects(this.focusIcons[e].bounds,d)){this.currentConstraint=this.constraints[e];this.currentPoint=this.focusPoints[e];c=this.focusIcons[e].bounds.clone();c.grow(mxClient.IS_IE?3:2);if(mxClient.IS_IE){c.width=c.width-1;c.height=c.height-1}if(this.focusHighlight==null){c=new mxRectangleShape(c,null,this.highlightColor,3);c.dialect=this.graph.dialect==mxConstants.DIALECT_SVG?mxConstants.DIALECT_SVG:
...
f=this.state.getVisibleTerminalState(false);if(f!=null&e!=null)if(mxUtils.contains(f,d[0].x,d[0].y))b[1].y==b[2].y?d[0].y=c.getRoutingCenterY(e):d[0].x=c.getRoutingCenterX(e);else if(mxUtils.contains(e,d[0].x,d[0].y))b[1].y==b[0].y?d[0].y=c.getRoutingCenterY(f):d[0].x=c.getRoutingCenterX(f)}else d.length==0&&(d=[a]);return d};
...
mxEditor.prototype.setGraphContainer=function(a){if(this.graph.container==null){this.graph.init(a);this.rubberband=new mxRubberband(this.graph);this.disableContextMenu&&mxEvent.disableContextMenu(a);mxClient.IS_IE&&new mxDivResizer(a)}};mxEditor.prototype.installDblClickHandler=function(a){a.addListener(mxEvent.DOUBLE_CLICK,mxUtils.bind(this,function(b,c){var d=c.getProperty("cell");if(d!=null&&a.isEnabled()&&this.dblClickAction!=null){this.execute(this.dblClickAction,d);c.consume()}}))};
...
mxEditor.prototype.setToolbarContainer=function(a){this.toolbar.init(a);mxClient.IS_IE&&new mxDivResizer(a)};
mxEditor.prototype.setStatusContainer=function(a){if(this.status==null){this.status=a;this.addListener(mxEvent.SAVE,mxUtils.bind(this,function(){var a=(new Date).toLocaleString();this.setStatus((mxResources.get(this.lastSavedResource)||this.lastSavedResource)+": "+a)}));this.addListener(mxEvent.OPEN,mxUtils.bind(this,function(){this.setStatus((mxResources.get(this.currentFileResource)||this.currentFileResource)+": "+this.filename)}));mxClient.IS_IE&&new mxDivResizer(a)}};
mxEditor.prototype.setStatus=function(a){if(this.status!=null&&a!=null)this.status.innerHTML=a};mxEditor.prototype.setTitleContainer=function(a){this.addListener(mxEvent.ROOT,mxUtils.bind(this,function(){a.innerHTML=this.getTitle()}));mxClient.IS_IE&&new mxDivResizer(a)};mxEditor.prototype.treeLayout=function(a,b){a!=null&&(new mxCompactTreeLayout(this.graph,b)).execute(a)};
