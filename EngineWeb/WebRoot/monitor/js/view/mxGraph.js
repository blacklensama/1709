 ...
 */
mxGraph.prototype.expandedImage = new mxImage(mxClient.imageBasePath + '/complete.gif', 16, 16);
...
mxGraph.prototype.completeImage = new mxImage(mxClient.imageBasePath + '/complete'+
		((mxClient.IS_MAC) ? '.png' : '.gif'), 16, 16);
